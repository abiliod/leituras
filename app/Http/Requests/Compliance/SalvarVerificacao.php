...
class SalvarVerificacao extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'inspetorcoordenador' => 'required|string|min:5',
            'inspetorcolaborador' => 'required|string|min:5',
    ...
    public function messages()
    {
        ...
        [
            ...
            'codigo.unique' => 'Já existe uma Pré Inspeção com esse Código',
            ...
            'inspetorcoordenador.string.min' => 'O campo :attribute deve ter no máximo 190 caracteres.',
            'inspetorcolaborador.string.min' => 'O campo :attribute deve ser um numero inteiro',
