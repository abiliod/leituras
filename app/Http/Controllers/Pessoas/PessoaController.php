...
*/
    ...
    public function addPessoa (Request $request)  {
        ...
        if($registro) {
            ...
            return view('admin.pessoas.manter', compact('registro','enderecos'));
        }
    ...
    public function showFormAdicionarPessoa()  {
        ...
        return view('admin.pessoas.adicionarPessoa');
...
//        if(!auth()->user()->can('pessoa_editar')){
  //          return redirect()->route('home');
    ...
    public function edicaoEndereco($id) {
        ...
        return view('admin.pessoas.editarEndereco', compact('registro' , 'endereco'));
    }
    ...
    public function showEntradaCEP($id) {
        ...
        return view('admin.pessoas.entradaCEP', compact('endereco', 'registro'));
    }
    ...
    public function atualizaPessoa(Request $request) {
      ...
      //  dd($Papel_user->papel_id);
        ...
        $dt         = $this->transformDate($registro['data_nasc_Fundacao']);
        $registro->data_nasc_Fundacao         = $dt;
    ...
    public function show(Request $request) {
        ...
        return view('admin.pessoas.manter', compact('registro','enderecos','papel'));
    }
    ...
    public function showEntradaCPF_CNPJ($id)  {
        ...
        if (($papel_user->papel_id == 1)||($papel_user->papel_id == 5)){
            $registro = Pessoa::find($id);
            $registro->status = 1;
            return view('admin.pessoas.entradaCPF_CNPJ', compact('registro','papel_user'));
        }
        else{
    ...
    public function index() {
        ...
        if($Papel_user->papel_id==5){
            return redirect()->route('admin.pessoas.entradaCPF_CNPJ', $registro->id);
        } else {
