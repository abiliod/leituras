                ...
                foreach($dados as $registro) {
                    ...
                    if(!empty(  $tipodeunidade->id ))
                    {
                        ...
                        if(!empty(  $enderecounidades->id ))
                        {
                            ...
                            $enderecos->numero =	$registro['municipio'];
                        ...
                        if (!$res){
                            ...
                            $unidade->qtdGuiche =$registro['quantidade_guiches'];
                            $unidade->qtdGuicheOcupado =$registro['guiches_ocupados'];
                            $unidade->telefoneddd =$registro['ddd'];
                            ...
                            $unidade->mcu_subordinacaoTecnica =$registro['subordinacao_tecnica'];
